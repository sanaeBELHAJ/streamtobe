 ...
 <section id="featured">
      ...
      <div class="container">
        <div class="row">
          <div class="span12">
            <div class="big-cta">
              <div class="cta-text">
                <h3>Devenez un star ou supporter les plus talentueux de nos streamer que vous aimez bien, les meilleurs offres vous attend!</h3>
              </div>
              <div class="cta floatright">
                <a class="btn btn-large btn-theme btn-rounded" href="#">Lire plus+</a>
              </div>
            </div>
          </div>
        </div>
    ...
    <section id="content">
      <div class="container">
        ...
        <div class="row">
          <div class="span12">
            <h4><strong>Star de la semaine</strong></h4>
