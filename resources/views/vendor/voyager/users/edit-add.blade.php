                    ...
                    {{-- <div class="panel"> --}}
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="pseudo" name="pseudo" placeholder="Pseudo de l'utilisateur"
                                       value="@if(isset($dataTypeContent->pseudo)){{ $dataTypeContent->pseudo }}@endif">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="description" name="description" 
                                    placeholder="Description de l'utilisateur">@if(isset($dataTypeContent->description)){{ $dataTypeContent->description }}@endif</textarea>
                            </div>
